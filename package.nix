...
let
  ...
  version = "0.53.0";
  commitSha = "a1ebb5b6cd971e55e5a6092413a3af68ed5a533e";
  hashes = {
    x86_64-linux = "sha256-Wq3FNsrRb85ctbmH0+oIbfUodN5H0QGgyZt1RZLNKoM=";
    aarch64-linux = "sha256-OTqCPUzUVOt5U/y9CIU9atl6iMbYkFEuCSknqtRcn5k=";
  };
