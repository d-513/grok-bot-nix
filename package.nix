...
let
  ...
  version = "0.44.0";
  commitSha = "12dcfa973ef51585fd1b35df6839fc9d1d7fd6aa";
  hashes = {
    x86_64-linux = "sha256-3e0YstPUSxwy1rn2NEbSsnvKaLPeeiqgKM55VulpQWQ=";
    aarch64-linux = "sha256-TxJ7s21Pm7ydufGhz0VeaHA5wJHXMId3ewGRefrezEY=";
  };
